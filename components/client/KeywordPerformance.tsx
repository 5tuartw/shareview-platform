                ...
                items={[
                  {
                    ...
                    tooltip: 'Distinct search terms included in this analysis window.',
                  },
                  {
                    label: 'Total Impressions',
                    value: formatNumber(summary.total_impressions),
                    tooltip: 'Total times the included search terms were shown.',
                  },
                  {
                    label: 'Total Clicks',
                    value: formatNumber(summary.total_clicks),
                    tooltip: 'Total clicks generated by the included search terms.',
                  },
                  {
                    label: 'Total Conversions',
                    value: formatNumber(summary.total_conversions),
                    tooltip: 'Total conversions attributed to the included search terms.',
                  },
                ]}
              />
