...
interface ConversionsCVRChartProps {
  data: Array<{ label: string; conversions: number; cvr: number }>
  highlightStart?: string
  highlightEnd?: string
}

export default function ConversionsCVRChart({ data, highlightStart, highlightEnd }: ConversionsCVRChartProps) {
  return (
