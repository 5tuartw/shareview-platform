...
const METRIC_CARD_TOOLTIPS: Record<string, string> = {
  Impressions: 'Total times the included products were shown in the selected period.',
  Clicks: 'Total clicks generated by the included products in the selected period.',
  Conversions: 'Total conversions attributed to the included products in the selected period.',
        ...
        {data.metric_cards && (
          ...
          <QuickStatsBar
            items={visibleCards.map((card) => ({
              ...
              tooltip: METRIC_CARD_TOOLTIPS[card.label],
