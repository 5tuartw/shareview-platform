                ...
                items={[
                  isMetricVisible('impressions')
                    ? {
                        ...
                        tooltip: 'Total times products in the current category view were shown.',
                      }
                    : null,
                  isMetricVisible('clicks')
                    ? {
                        ...
                        tooltip: 'Total clicks generated by products in the current category view.',
                      }
                    : null,
                  isMetricVisible('conversions')
                    ? {
                        ...
                        tooltip: 'Total conversions attributed to products in the current category view.',
                      }
                    : null,
                  isMetricVisible('ctr')
                    ? {
